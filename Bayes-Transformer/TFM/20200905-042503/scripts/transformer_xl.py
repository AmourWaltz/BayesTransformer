...
class BayesPositionwiseFF(nn.Module):
    def __init__(self, d_model, d_inner, dropout):
        ...
        self.d_inner = d_inner
        self.dropout = dropout
        self.weight_mean1 = nn.Parameter(torch.rand(self.d_model, self.d_inner))
        self.weight_mean2 = nn.Parameter(torch.rand(self.d_inner, self.d_model))
        self.weight_std1 = nn.Parameter(torch.rand(self.d_model, self.d_inner))
        self.weight_std2 = nn.Parameter(torch.rand(self.d_inner, self.d_model))
